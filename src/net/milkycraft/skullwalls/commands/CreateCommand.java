...
import net.milkycraft.skullwalls.walls.SlotNotFoundException;
...
public class CreateCommand extends BaseCommand {
	...
	public CreateCommand(final SkullWalls plugin) {
		super(plugin);
	...
	public void runCommand(final CommandSender sender, final List<String> args) {
		...
		if (args.size() == 0) {
			...
			try {
				...
				wall = super.plugin.getCuboider().createWall((Player) sender, type,
				...
				sender.sendMessage(RED + "Error: Your wall is not large enough!");
				return;
